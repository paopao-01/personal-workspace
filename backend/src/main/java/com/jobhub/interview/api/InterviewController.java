...
public class InterviewController {
    ...
    @PutMapping("/interviews/{id}/checklist/{itemId}") public ResponseEntity<InterviewResponse> updateChecklist(@PathVariable String id,@PathVariable String itemId,@RequestHeader(value="If-Match-Version",required=false) Long version,@Valid @RequestBody ChecklistUpdateRequest request){if(version==null)return ResponseEntity.badRequest().build();return ResponseEntity.ok(response(service.updateChecklistItem(id,version,itemId,request.completed())));}
    ...
    @DeleteMapping("/interviews/{id}") public ResponseEntity<Void> delete(@PathVariable String id,@RequestHeader(value="If-Match-Version",required=false) Long version){if(version==null)return ResponseEntity.badRequest().build();service.delete(id,version);return ResponseEntity.noContent().build();}
