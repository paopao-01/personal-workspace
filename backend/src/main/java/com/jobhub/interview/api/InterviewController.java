...
public class InterviewController {
    ...
    @GetMapping("/interviews") public List<InterviewResponse> list(@RequestParam(required=false) String from,@RequestParam(required=false) String to,@RequestParam(required=false) InterviewScheduleStatus scheduleStatus){return service.list(from,to,scheduleStatus).stream().map(this::response).toList();}
    ...
    @GetMapping("/interviews/upcoming") public List<InterviewResponse> upcoming(@RequestParam(required=false) String from,@RequestParam(required=false) String to,@RequestParam(required=false) InterviewScheduleStatus status){return list(from,to,status);}
