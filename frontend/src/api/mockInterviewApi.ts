...
type S=components['schemas']; export type MockInterviewSession=S['MockInterviewSession']; export type MockInterviewTurn=S['MockInterviewTurn']; export type MockInterviewEvaluationSummary=S['MockInterviewEvaluationSummary']
