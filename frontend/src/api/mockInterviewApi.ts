...
export const answerMockInterview=async(id:string,version:number,content:string)=> (await apiClient.post<MockInterviewTurn>(`/mock-interviews/${id}/answers`,{content},{headers:{...h(),'If-Match-Version':String(version)}})).data
