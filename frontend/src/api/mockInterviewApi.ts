...
type S=components['schemas']; export type MockInterviewSession=S['MockInterviewSession']; export type MockInterviewTurn=S['MockInterviewTurn']; export type MockInterviewEvaluationSummary=S['MockInterviewEvaluationSummary']; export type MockInterviewEvaluationTrend=S['MockInterviewEvaluationTrend']
...
export const getMockInterviewEvaluationSummary=async()=> (await apiClient.get<MockInterviewEvaluationSummary>('/mock-interviews/evaluation-summary')).data
export const getMockInterviewEvaluationTrend=async(params:{from:string;to:string;compareFrom:string;compareTo:string})=> (await apiClient.get<MockInterviewEvaluationTrend>('/mock-interviews/evaluation-trend',{params})).data
